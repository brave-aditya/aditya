      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-7 place-self-center text-center sm:text-left">
          <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-6xl font-extrabold">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#f871fa]  to-[#ff0039]">
              Hello, I'm{" "}
            </span>
            <br />
            <TypeAnimation
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            ...
            libero quas quod corrupti mollitia? Libero rerum dolor non laborum
            neque iusto laboriosam dolorem saepe deleniti, esse dolorum delectus
            perspiciatis unde?
          </p>
          <div>
            <button className="px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-[#ff0039] via-[#fc00ff] to-[#ff0039] hover:bg-slate-200 text-white">
              Contact Me
            </button>
